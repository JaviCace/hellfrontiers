...
Javier Cáceres
  ...
  ----------------------------------- -----------------------------------
  Genre                              Plataform/Action

  Númber of players                   1 player

  Plataform                           PC - Window 10 or higher
  -----------------------------------------------------------------------
...
The player will be able to move horizonatly and jump. He will be able to attack in the cardinal directions and change orbs during the battle and use the orbs respective ability. The player will be able to interact with diferent puzzles along the game. 
...
**Buttons**
The player can interact with buttons that activate when colisoning with them'; this changes the button's texture and sends a signal to the corresponding door. These are used primarily in the SadnessBossDoor puzzle.

# **Progression Content**

My main plan is to have the first zone in week six, with the first 2 enemies and boss, maybe even the second zone with the next 2 enemmies and 2 boss. And for the final week the plan is the rest of the enemies and the last 3 bosses including the floor is lava gameplay. 